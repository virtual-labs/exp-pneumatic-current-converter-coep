...
//		  {
			  TransmitterDB +=' <div class="successMsg">Congratulations!!! Temperature control system (P/E converter) experiment is completed successfully!! <br/><span id="AnalysisStatus"></span></div>'
