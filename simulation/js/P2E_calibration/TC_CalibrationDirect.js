...
//			//console.log("Min Diffrence "+ minDiff);
	...
	var TC_updatedDataTable = function(TColdreadingSorted,TCarr_actualValSorted)
	{
      ...
      //         + '<div class="col-md-12" ><p>After few months P/E converter is not working properly.  As a maintenance engineer, Please attend the fault &nbsp;&nbsp; </p>'
				+ '<div class="col-md-12" ><p>After few months it is observed that P/E converteris not working properly. As a maintenance engineer, please identify and rectify the fault &nbsp;&nbsp; </p>'
